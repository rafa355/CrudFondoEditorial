  ...
  public resultadoCarga;
    ...
    save(model) {
      ...
      this.CargarArchivo(this.archivo)
        ...
        //Metodo para activar etapa
        ActivarEtapa() {
          this.etapasservice.activar_etapa('4',this.id).subscribe(
        ...
        CerrarEtapa() {
          this.etapasservice.cerrar_etapa('4',this.id).subscribe(
        ...
        crear_comentario(adjunto) {
          ...
          public CargarArchivo(files: FileList){
            this.enviandoArchivo.EnviarArchivo(files[0],'4',this.id).subscribe(
              data => {
