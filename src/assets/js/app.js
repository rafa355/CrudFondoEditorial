    ...
    var menubar = {
        ...
        reduceAppMenu: function() {
            ...
            if ($menuItems.length > 6) {
                ...
                $moreItemsToggle.append(['<i class="menu-icon zmdi zmdi-more-vert zmdi-hc-lg"></i>', '<span class="menu-text">Más</span>', '<i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>']);
